...
<div class="container-fluid ">
    <table class="table table-hover table-bordered">
        ...
        <tr>
            ...
            <td style="vertical-align: middle;"><input type="text"  class=" input" placeholder="设置最小人数" />&nbsp;-&nbsp;<input  class=" input"  type="text" placeholder="设置最大人数" />&nbsp;&yen;&nbsp;<input  class=" input"  type="text" placeholder="设置奖金" /></td>
        </tr>
        <tr>
