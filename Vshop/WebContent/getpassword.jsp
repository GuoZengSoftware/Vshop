            ...
            <div
                ...
                <div
                    ...
                    <div style="border-bottom: 1px solid #E0E0E0;">
                        <label>账号：</label> <input type="text" id="user_account"
                                                  style="border: none; background-color: #fbfbfb; width: 200px; height: 40px;" />
                    </div>
                    <div style="border-bottom: 1px solid #E0E0E0;">
                        <label>密问：</label> <select id="user_matter"
                            style="border: none; background-color: #fbfbfb; width: 200px; height: 40px;">
                    ...
                    <div>
                        <label>密答：</label> <input type="text" id="user_answer"
                                                  style="border: none; background-color: #fbfbfb; width: 200px; height: 40px;" />
                    </div>
                </div>
                ...
                <div style="width: 302px; margin: 0px auto; margin-top: 30px;">
                    <button type="submit" class="getpassword"
